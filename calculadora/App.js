...
import Btn from './componentes/Calculadora/Botao';
     ...
     <SafeAreaView style={estilos.container}>
      <Text> Calculadora - CFB Cursos </Text> 
       ...
       <View style={estilos.botoes}>
        <Btn label ='AC' ac aoClicar={()=>{limparTela()}}></Btn>
        ...
        <Btn label ='%' operacao duplo aoClicar={()=>{addDigito('%')}}></Btn>
        <Btn label ='&' operacao duplo aoClicar={()=>{addDigito('&')}}></Btn>
      </View>
    </SafeAreaView>
  );   
